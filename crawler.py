...
class Crawler(object):
    ...
    def crawl_page(self, start_date, end_date, page=''):
        ...
        dates = root.xpath('//tbody/tr/td[1]/text()')
        dates = list(map(lambda x: datetime.strptime(x, "%Y-%m-%d"), dates))

        titles = root.xpath('//tbody/tr/td[2]/a/text()')
        rel_urls = root.xpath('//tbody/tr/td[2]/a/@href')
    ...
    def crawl_content(self, url):
        ...
        content = ' '.join(root.xpath('//*[@id="content2"]/div[2]//text()'))
